...
interface WallClapperPreviewCardProps {
  firstName: string
  lastName: string
  email: string
...
export default function WallClapperPreviewCard({
  ...
  if (!hasAny) {
    return (
      <div className="flex flex-col items-center text-center p-6 rounded-2xl border border-dashed border-border bg-muted/20">
        <ClapIcon />
        <p className="mt-2 text-muted text-sm">Fill the form to see preview</p>
      </div>
    )
  }
